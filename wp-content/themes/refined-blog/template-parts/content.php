        ...
        <div class="refined-magazine-content-area">
            <header class="entry-header">
                ...
                if (is_singular()) :
                    ...
                    the_title('<h2 class="entry-title ddd" ' . refined_magazine_get_microdata("heading") . '><a href="' . esc_url(get_permalink()) . '" rel="bookmark">', '</a></h2>');
                endif;
            ...
            <div class="entry-content">
                ...
                wp_link_pages(array(
                    'before' => '<div class="page-links">' . esc_html__('Pages:', 'refined-blog'),
                    'after' => '</div>',
                ));
                ?>
